    ...
    case 0: // Full-Service
      return (
        <div className="relative w-full h-full flex items-center justify-center">
             ...
             <div className="relative z-10 bg-brand-navy border border-brand-teal p-3 rounded-xl shadow-[0_0_20px_rgba(121,243,222,0.15)]">
...
interface MarketSectionProps {
  onNavigate: (page: 'home' | 'about' | 'services' | 'contact' | 'faq') => void;
}

export const ModelsSection: React.FC<MarketSectionProps> = ({ onNavigate }) => (
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="mt-12 text-center">
        <a 
          ...
          className="inline-flex items-center px-8 py-3 border border-brand-teal text-brand-teal font-bold rounded hover:bg-brand-teal hover:text-brand-navy transition-all duration-300 group"
        >
          Learn More
