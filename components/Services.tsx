...
const FullServiceVisual = () => (
  <div className="relative w-full h-64 bg-brand-navy/50 rounded-xl border border-brand-border overflow-hidden flex items-center justify-center">
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(121,243,222,0.05)_0%,transparent_60%)]" />
    <motion.div 
      animate={{ rotate: 360 }}
    ...
    <div className="relative z-10 grid grid-cols-2 gap-4">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-8 h-8 bg-brand-teal rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(121,243,222,0.5)]">
...
const AdvisoryVisual = () => (
  <div className="relative w-full h-64 bg-brand-navy/50 rounded-xl border border-brand-border overflow-hidden flex items-center justify-center">
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(121,243,222,0.02)_0%,transparent_60%)]" />
    ...
    <div className="relative w-48 h-48 rounded-full border border-brand-border/30 flex items-center justify-center bg-brand-card/10 backdrop-blur-sm shadow-inner">
      ...
      {/* Center Cap */}
      <div className="absolute w-4 h-4 bg-brand-navy border-2 border-brand-teal rounded-full z-10 shadow-[0_0_10px_rgba(121,243,222,0.5)]" />
    </div>
...
const ServicesPage: React.FC<ServicesPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="pt-20 bg-brand-navy min-h-screen font-sans">
      ...
      {/* SECTION 1: HERO */}
      <section className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6 relative overflow-hidden z-10 bg-brand-navy">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(20,88,151,0.1)_0%,transparent_70%)] pointer-events-none" />
        <motion.div
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div 
                key={i}
                whileHover={{ y: -5, borderColor: 'rgba(121,243,222,0.3)' }}
      ...
      <section id="model-01" className="py-24 bg-brand-navy relative scroll-mt-20">
        ...
        <div className="container mx-auto px-6 mt-12">
           <div className="bg-brand-card border-l-4 border-brand-teal p-6 rounded-r-xl flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <button onClick={() => onNavigate('contact')} className="px-6 py-3 bg-brand-teal text-brand-navy font-bold rounded hover:bg-white transition-colors whitespace-nowrap">
      ...
      <section id="model-02" className="py-24 bg-brand-section relative scroll-mt-20">
        ...
        <div className="container mx-auto px-6 mt-12">
           <div className="bg-brand-card border-l-4 border-brand-blue p-6 rounded-r-xl flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <button onClick={() => onNavigate('contact')} className="px-6 py-3 bg-brand-blue text-brand-white font-bold rounded hover:bg-brand-white hover:text-brand-navy transition-colors whitespace-nowrap">
      ...
      <section className="py-24 bg-brand-section/50">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-12">
             ...
             <button onClick={() => onNavigate('contact')} className="px-8 py-3 border border-brand-teal text-brand-teal font-bold rounded hover:bg-brand-teal hover:text-brand-navy transition-all">
      ...
      <section className="py-24 bg-gradient-to-r from-brand-blue to-brand-teal text-brand-navy relative z-10">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="mt-8 text-sm font-bold">
             Prefer email? <a href="mailto:hello@sponsrbridge.io" className="underline hover:text-white">hello@sponsrbridge.io</a>
          </div>
        </div>
      </section>
